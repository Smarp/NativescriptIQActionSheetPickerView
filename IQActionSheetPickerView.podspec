Pod::Spec.new do |s|
	...
	s.authors   = { 'Iftekhar Qurashin' => 'hack.iftekhar@gmail.com', 'Antonio Cueva' => 'cuevajodar@gmail.com' }
	s.source    = { :git => 'https://github.com/Smarp/NativescriptIQActionSheetPickerView.git', :tag => 'v1.1.0' }
	s.platform = :ios, '5.0'
